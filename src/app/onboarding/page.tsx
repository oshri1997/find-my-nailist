          ...
          <AnimatePresence mode="wait">
            ...
            {step === 3 && (
              <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }}>
                ...
                <p className="text-muted-foreground text-sm mb-5">
                  ...
                  <span className={`mr-2 font-bold ${photos.length >= 3 ? 'text-emerald-500' : 'text-primary'}`}>
                    ({photos.length}/3)
                  </span>
                </p>
                ...
                <div className="grid grid-cols-3 gap-3 mb-5">
                  ...
                  <button
                    ...
                    disabled={uploading}
                    className="aspect-square rounded-xl border-2 border-dashed border-border flex flex-col items-center justify-center gap-1 hover:border-primary/40 hover:bg-primary/30 transition-all text-muted-foreground hover:text-primary disabled:opacity-50"
                  >
              ...
              <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }}>
                      ...
                      <div key={s.id} className="flex items-center gap-3 bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/30 dark:to-primary/15 rounded-xl px-4 py-3">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          <button
                            ...
                            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/60 dark:hover:bg-white/10 text-muted-foreground/60 hover:text-primary transition-colors"
                            title="עריכה"
                          >
                ...
                <div className="border border-border rounded-2xl p-4 bg-muted/30 space-y-3">
                    ...
                    <div className="flex-1">
                      ...
                      {isCustomDuration && (
                        <Input
                          ...
                          className="mt-2 rounded-xl border-border focus:border-primary h-11 bg-card"
                        />
                      )}
                    </div>
                    <div className="flex-1">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full rounded-xl h-10 font-bold border-primary/30 text-primary hover:bg-primary/10 hover:text-primary gap-2 disabled:opacity-50"
                  >
                    {saving ? (
            ...
            {step === 5 && (
              <motion.div key="step5" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }}>
                ...
                <p className="text-muted-foreground text-sm mb-6">אופציונלי — הוסיפי קישורים כדי שלקוחות יוכלו למצוא אותך גם ברשתות החברתיות.</p>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="url"
                      dir="ltr"
                      className="rounded-xl border-border focus:border-primary h-11 text-left placeholder:text-right"
                    />
                  </div>
              ...
              <motion.div key="step6" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }}>
                ...
                <div className="space-y-2 mb-5">
                  {workingHours.map((day, i) => (
                    <div
                      key={i}
                      className={`rounded-xl border px-4 py-3 transition-all ${day.isActive ? 'border-primary/30 bg-primary/40' : 'border-border bg-muted/30'}`}
                    >
