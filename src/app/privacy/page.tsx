      ...
      <main className="flex-1 container mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-foreground">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1.5 text-muted-foreground pr-2">
                  ...
                  <li>ספירה אנונימית של כניסות לפי מקור כללי בלבד: Google, קישור ישיר או מקור אחר. הספירה אינה כוללת שם, חשבון, כתובת עמוד, כתובת IP או מזהה קבוע.</li>
                </ul>
              </div>
              <div>
          ...
          <section id="cookies" className="space-y-3 scroll-mt-24">
            ...
            <p className="text-muted-foreground leading-relaxed">
              האתר משתמש בעוגיות הכרחיות לצורך שמירת מצב ההתחברות. לצורך הגנה מפני שימוש לרעה בספירת הכניסות, נשמרת עוגייה זמנית וחתומה למשך עד 10 דקות. בנוסף, השרת מגביל זמנית בקשות לפי ערך גיבוב חד־כיווני של כתובת הרשת; כתובת הרשת הגולמית אינה נשמרת או נכתבת למסד הנתונים. אין שימוש בעוגיות פרסומיות או ניתוח התנהגות מעבר לנדרש לתפעול השירות.
            </p>
          </section>
