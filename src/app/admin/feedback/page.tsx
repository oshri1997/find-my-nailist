  ...
  return (
    <div className="p-4 md:p-8" dir="rtl">
      <div className="mx-auto max-w-7xl space-y-5 md:space-y-6">
        ...
        {loading ? (
          <div className="flex min-h-72 items-center justify-center rounded-2xl border border-border bg-card"><Loader2 className="h-7 w-7 animate-spin text-primary" aria-label="טוענת פניות" /></div>
        ) : error ? (
