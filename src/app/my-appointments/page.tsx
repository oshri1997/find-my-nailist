                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    {apt.status === 'COMPLETED' && !apt.hasReview && (
                      <button
                        ...
                        className="text-xs font-bold px-3 py-1.5 rounded-full bg-gradient-to-r from-primary to-primary/60 text-white cursor-pointer hover:opacity-90 transition-opacity whitespace-nowrap"
                      >
                        כתבי ביקורת
                      </button>
                    )}
