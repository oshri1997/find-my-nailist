...
function Content() {
  ...
  return (
    <div className="text-center">
      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-amber-600 flex items-center justify-center mx-auto mb-6 shadow-lg shadow-primary/30">
      ...
      <div className="bg-card rounded-3xl shadow-xl p-10 max-w-md w-full">
        ...
        <div className="mt-8 text-center">
          <Link
            ...
            className="inline-block bg-gradient-to-r from-primary to-amber-600 text-white font-black rounded-xl px-6 py-3 text-sm hover:opacity-90 transition"
          >
            לוח התורים שלי
          </Link>
        </div>
