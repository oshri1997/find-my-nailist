...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'ניתן לקבוע תור לעיצוב ג׳ל, נייל ארט, מניקור קלאסי, פדיקור, הסרה, חיזוק ציפורניים ועוד — בהתאם לשירותים שמציעה כל נייליסטית.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'כן, השימוש באתר חינם. התשלום מתבצע ישירות לנייליסטית; חלקן עשויות לבקש מקדמה מראש.',
      },
    },
    {
      '@type': 'Question',
