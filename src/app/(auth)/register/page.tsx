  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4">
      ...
      <motion.div
        ...
        className="absolute bottom-[-20%] right-[-10%] w-[400px] h-[400px] rounded-full opacity-30"
      ...
      >
        ...
        <div className="glass rounded-3xl p-8 shadow-2xl shadow-pink-100/50">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">צרי חשבון חינמי בכמה שניות</p>
          </div>
          ...
          <div className="flex rounded-2xl bg-gray-100 p-1 mb-6">
            {(['nailist', 'client'] as const).map((r) => (
              ...
              >
                {r === 'nailist' ? '💅' : '🌸'} {r === 'nailist' ? 'נייליסטית' : 'לקוחה'}
              </button>
            ))}
          </div>
